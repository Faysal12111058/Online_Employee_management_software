...
def addemployee():
    ...
    idlabel = Label(addroot, text='Enter Id : ', bg='#ffffff', font=('verdana', 15), width=12, anchor='w')
    idlabel.place(x=10, y=10)

    namelabel = Label(addroot, text='Enter Name : ', bg='#ffffff', font=('verdana', 15), width=12, anchor='w')
    namelabel.place(x=10, y=70)

    mobilelabel = Label(addroot, text='Enter Mobile : ',bg='#ffffff', font=('verdana', 15), width=12, anchor='w')
    mobilelabel.place(x=10, y=130)

    emaillabel = Label(addroot, text='Enter Email : ',bg='#ffffff', font=('verdana', 15), width=12, anchor='w')
    emaillabel.place(x=10, y=190)

    addresslabel = Label(addroot, text='Enter Address: ',bg='#ffffff', font=('verdana', 15), width=12, anchor='w')
    addresslabel.place(x=10, y=250)  # DCAE96

    genderlabel = Label(addroot, text='Enter Gender : ', bg='#ffffff', font=('verdana', 15), width=12, anchor='w')
    genderlabel.place(x=10, y=310)

    salarylabel = Label(addroot, text='Enter Salary : ', bg='#ffffff', font=('verdana', 15), width=12, anchor='w')
    salarylabel.place(x=10, y=370)

    #------------------- Addemployee Entrybg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    idval = StringVar()
    nameval = StringVar()
    mobileval = StringVar()
    emailval = StringVar()
    ...
    identry = Entry(addroot, font=('Helvetica', 15, 'bold'), bd=1, textvariable=idval, width=18)
    identry.place(x=250, y=10)

    nameentry = Entry(addroot, font=('Helvetica', 15, 'bold'), bd=1, textvariable=nameval, width=18)
    nameentry.place(x=250, y=70)

    mobileentry = Entry(addroot, font=('Helvetica', 15, 'bold'), bd=1, textvariable=mobileval, width=18)
    mobileentry.place(x=250, y=130)

    emailentry = Entry(addroot, font=('Helvetica', 15, 'bold'), bd=1, textvariable=emailval, width=18)
    emailentry.place(x=250, y=190)

    addressentry = Entry(addroot, font=('Helvetica', 15, 'bold'), bd=1, textvariable=addressval, width=18)
    addressentry.place(x=250, y=250)

    genderentry = Entry(addroot, font=('Helvetica', 15, 'bold'), bd=1, textvariable=genderval, width=18)
    genderentry.place(x=250, y=310)

    salaryentry = Entry(addroot, font=('Helvetica', 15, 'bold'), bd=1, textvariable=salaryval, width=18)
    salaryentry.place(x=250, y=370)
    
    #------------------------- addemployee submit button
    submitbtn = Button(addroot, text="Submit", bd=1, font=("Bodoni", 16), width=10,fg="white")
    submitbtn.config(relief="raised", bg="#000000", activebackground="yellow", command=submitadd)
...
def searchemployee():
    ...
    idlabel = Label(searchroot, text='Enter Id : ',bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    idlabel.place(x=10, y=10)

    namelabel = Label(searchroot, text='Enter Name : ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    namelabel.place(x=10, y=70)

    mobilelabel = Label(searchroot, text='Enter Mobile : ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    mobilelabel.place(x=10, y=130)

    emaillabel = Label(searchroot, text='Enter Email : ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    emaillabel.place(x=10, y=190)

    addresslabel = Label(searchroot, text='Enter Address: ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    addresslabel.place(x=10, y=250)  # DCAE96

    genderlabel = Label(searchroot, text='Enter Gender : ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    genderlabel.place(x=10, y=310)

    salarylabel = Label(searchroot, text='Enter Salary : ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    salarylabel.place(x=10, y=370)

    datelabel = Label(searchroot, text='Enter Date : ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    ...
    identry = Entry(searchroot, font=('arial', 13, 'bold'), bd=1, textvariable=idval)
    identry.place(x=250, y=10)

    nameentry = Entry(searchroot, font=('arial', 13, 'bold'), bd=1, textvariable=nameval)
    nameentry.place(x=250, y=70)

    mobileentry = Entry(searchroot, font=('arial', 13, 'bold'), bd=1, textvariable=mobileval)
    mobileentry.place(x=250, y=130)

    emailentry = Entry(searchroot, font=('arial', 13, 'bold'), bd=1, textvariable=emailval)
    emailentry.place(x=250, y=190)

    addressentry = Entry(searchroot, font=('arial', 13, 'bold'), bd=1, textvariable=addressval)
    addressentry.place(x=250, y=250)

    genderentry = Entry(searchroot, font=('arial', 13, 'bold'), bd=1, textvariable=genderval)
    genderentry.place(x=250, y=310)

    salaryentry = Entry(searchroot, font=('arial', 13, 'bold'), bd=1, textvariable=salaryval)
    salaryentry.place(x=250, y=370)

    dateentry = Entry(searchroot, font=('arial', 13, 'bold'), bd=1, textvariable=dateval)
    dateentry.place(x=250, y=430)
    
    #------------------------- search button
    searchbtn = Button(searchroot, text='Search', bd=3,fg="white", font=("Bodoni", 16), width=10, command=search)
...
def updateemployee():
    ...
    idlabel = Label(updateroot, text='Enter Id : ',bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    idlabel.place(x=10, y=10)

    namelabel = Label(updateroot, text='Enter Name : ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    namelabel.place(x=10, y=70)

    mobilelabel = Label(updateroot, text='Enter Mobile : ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    mobilelabel.place(x=10, y=130)

    emaillabel = Label(updateroot, text='Enter Email : ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    emaillabel.place(x=10, y=190)

    addresslabel = Label(updateroot, text='Enter Address: ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    addresslabel.place(x=10, y=250)  # DCAE96

    genderlabel = Label(updateroot, text='Enter Gender : ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    genderlabel.place(x=10, y=310)

    salarylabel = Label(updateroot, text='Enter Salary : ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    salarylabel.place(x=10, y=370)

    datelabel = Label(updateroot, text='Enter Date : ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    datelabel.place(x=10, y=430)

    timelabel = Label(updateroot, text='Enter Time : ', bg='#ffffff', font=('verdana', 17), width=12, anchor='w')
    ...
    identry = Entry(updateroot, font=('arial', 12, 'bold'), bd=1, textvariable=idval)
    identry.place(x=250, y=10)

    nameentry = Entry(updateroot, font=('arial', 12, 'bold'), bd=1, textvariable=nameval)
    nameentry.place(x=250, y=70)

    mobileentry = Entry(updateroot, font=('arial', 12, 'bold'), bd=1, textvariable=mobileval)
    mobileentry.place(x=250, y=130)

    emailentry = Entry(updateroot, font=('arial', 12, 'bold'), bd=1, textvariable=emailval)
    emailentry.place(x=250, y=190)

    addressentry = Entry(updateroot, font=('arial', 12, 'bold'), bd=1, textvariable=addressval)
    addressentry.place(x=250, y=250)

    genderentry = Entry(updateroot, font=('arial', 12, 'bold'), bd=1, textvariable=genderval)
    genderentry.place(x=250, y=310)

    salaryentry = Entry(updateroot, font=('arial', 12, 'bold'), bd=1, textvariable=salaryval)
    salaryentry.place(x=250, y=370)

    dateentry = Entry(updateroot, font=('arial', 12, 'bold'), bd=1, textvariable=dateval)
    dateentry.place(x=250, y=430)

    timeentry = Entry(updateroot, font=('arial', 12, 'bold'), bd=1, textvariable=timeval)
    timeentry.place(x=250, y=490)
    
    #------------------------- update button
    updatebtn = Button(updateroot, text="Update", bd=3,fg="white", font=("Bodoni", 16, "bold"), width=10,command=update)
...
def Connectdb():
    ...
    # ----------------------Connectdb Labels
    label1 = Label(dbroot, text="Login to database with MySQL credentials", bg="white", fg="black", font=("verdana", 14, "bold"))
    label1.pack(side="top", fill=BOTH)

    userlabel = Label(dbroot, text="MySQL Id :", font=("verdana", 12),bg="white")
    userlabel.place(x=75, y=75)

    passwordlabel = Label(dbroot, text="MySQL Password :", font=("verdana", 12),bg="white")
    ...
    userentry = Entry(dbroot, textvariable=userval, bd=1, bg="white", relief="raised", width=30,font=("arial",15))
    userentry.place(x=75, y=110)

    passwordentry = Entry(dbroot, textvariable=passwordval, bd=1, bg="white",font=("arial",15), relief="raised", width=30, show="*")
    passwordentry.place(x=75, y=185)

    # -----------------------login button & exit button
    login_button = Button(dbroot, text="Login", bg="black",font=("arial", 12,"bold"),
                          command=submitdb)
    login_button.config(activebackground="black", activeforeground="white",fg="white",padx=10,pady=10)
    login_button.place(x=75, y=235)

    exit_button = Button(dbroot, text="Exit", bg="black",font=("arial", 12,"bold"),fg="white",
                         command=dbroot.destroy)
    exit_button.config(activebackground="black", activeforeground="#ffffff",padx=10,pady=10)
...
addbtn = Button(DataEntryFrame, text="Add Employee", relief="raised", bg="black",fg="white", font=("verdana", 14),
                width=20, command=addemployee)
addbtn.place(x=20, y=100)

updatebtn = Button(DataEntryFrame, text="Update Record", relief="raised", bg="black",fg="white", font=("verdana", 14),
                width=20, command=updateemployee)
updatebtn.place(x=20, y=180)

searchbtn = Button(DataEntryFrame, text="Search Record", relief="raised", bg="black",fg="white", font=("verdana", 14),
                width=20, command=searchemployee)
searchbtn.place(x=20, y=260)

delete_button = Button(DataEntryFrame, text="Delete Record", relief="raised", bg="black",fg="white", font=("verdana", 14),
                width=20, command=deleteemployee)
delete_button.place(x=20, y=340)

showall_button = Button(DataEntryFrame, text="Show All Records", relief="raised", bg="black",fg="white", font=("verdana", 14),
                width=20, command=showallrecords)
showall_button.place(x=20, y=420)

exit_button = Button(DataEntryFrame, text="Exit", relief="raised", bg="black",fg="white", font=("verdana", 14),
...
style = ttk.Style()
style.configure('Treeview.Heading', font=('verdana', 12, 'bold'), foreground='Black')
style.configure('Treeview', font=('Helvetica', 12), foreground='black', background='lavender')
...
#------------------------------------ MAIN LABEL/HEADING
main_label = Label(root, text="EMPLOYEE MANAGEMENT SYSTEM", bg="white", fg="black",
                   font=("arial", 22, "bold"))
main_label.pack(side="top")

#------------------------------------ DATE&TIME
clock = Label(root, font=('verdana', 10, 'bold'), borderwidth=3, bg='white', fg="black")
clock.place(x=930, y=5)
tick()
#------------------------------------ LOGIN DATABASE BUTTON
connectbutton = Button(root, text='Login SQL', width=16, font=("verdana", 14, "bold"), command=Connectdb)
connectbutton.config(bg="black", fg="white", activebackground="yellow", activeforeground="black")
